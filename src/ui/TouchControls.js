export class TouchControls {
  ...
  build() {
    ...
    lookZone.addEventListener('pointerdown', (e) => { e.preventDefault(); lookStart = { x: e.clientX, y: e.clientY }; lookZone.setPointerCapture?.(e.pointerId); });
    ...
    fire.addEventListener('pointerdown', (e) => { e.preventDefault(); this.input.fire = true; fire.setPointerCapture?.(e.pointerId); });
